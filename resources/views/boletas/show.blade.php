...
<div class="card border-0 shadow-sm rounded-4" style="background:#fff;">
    <div class="card-body p-0">
        ...
        <div class="px-4 py-3">
            ...
            <!-- Cliente -->
            @if($venta->cliente)
            <div style="background:#f0fdf4;border-radius:10px;padding:12px;margin-bottom:12px;font-size:13px;">
            ...
            <div style="border-top:2px dashed #d4d4d4;border-bottom:2px dashed #d4d4d4;padding:12px 0;margin:12px 0;">
            ...
            <table style="width:100%;font-size:13px;margin-bottom:12px;">
                ...
                <tr style="border-top:2px solid #d4d4d4;">
                    <td class="pt-2 fw-bold" style="font-size:16px;">TOTAL</td>
                    <td class="pt-2 text-end fw-bold" style="font-size:18px;color:#16a34a;">S/ {{ number_format($venta->total,2) }}</td>
                </tr>
            </table>

            <!-- Pago y Vendedor -->
            <div style="background:#f0fdf4;border-radius:10px;padding:12px;font-size:13px;text-align:center;">
                <span class="fw-bold" style="color:#16a34a;">Pago: {{ strtoupper($venta->metodo_pago) }}</span>
            ...
            <div style="text-align:center;font-size:12px;color:#9ca3af;margin-top:16px;padding-bottom:8px;">
