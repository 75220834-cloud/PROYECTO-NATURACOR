...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div>
        <h4 class="fw-bold mb-0" style="color:#1a2e1a">📖 {{ $recetario->nombre }}</h4>
        @if($recetario->categoria)
        <span class="badge" style="background:#f0fdf4;color:#15803d;font-size:11px;">{{ $recetario->categoria }}</span>
        @endif
    </div>
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body px-4 pb-4">
                ...
                <div class="d-flex align-items-center gap-3 p-3 rounded-3 mb-2" style="background:#f9fafb;border:1px solid #e5e7eb;">
                    <div style="width:40px;height:40px;background:linear-gradient(135deg,#bbf7d0,#86efac);border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0;">🌿</div>
                    ...
                    <div class="fw-bold" style="color:#16a34a;">S/ {{ number_format($prod->precio, 2) }}</div>
                </div>
                @empty
